 ...
 */
public class QuizHtmlQuestion10 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedStateInstance){
        ...
        setContentView(R.layout.quiz_html_question10);
    }

    public void continueQuiz(View view){

        radioButton1 = (RadioButton)findViewById(R.id.quiz_html_option10_1);
        radioButton2 = (RadioButton)findViewById(R.id.quiz_html_option10_2);
        ...
        if(extras.containsKey("POINTS")) {
            ...
            if(!radioButton1.isChecked() && !radioButton2.isChecked()){
                ...
                Log.v("points quiz 10: ", "" + pointsHtml);
                intent = new Intent(this, QuizPoints.class);
