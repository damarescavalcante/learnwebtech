 ...
 */
public class QuizHtmlQuestion9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedStateInstance){
        ...
        setContentView(R.layout.quiz_html_question9);
    }

    public void continueQuiz(View view){

        radioButton1 = (RadioButton)findViewById(R.id.quiz_html_option9_1);
        radioButton2 = (RadioButton)findViewById(R.id.quiz_html_option9_2);
        ...
        if(extras.containsKey("POINTS")) {
            ...
            if(!radioButton1.isChecked() && !radioButton2.isChecked()){
                ...
                Log.v("points quiz 8: ", "" + pointsHtml);
                intent = new Intent(this, QuizHtmlQuestion10.class);
