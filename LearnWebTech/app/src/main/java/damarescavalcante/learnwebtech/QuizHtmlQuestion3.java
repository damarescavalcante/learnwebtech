 ...
 */
public class QuizHtmlQuestion3 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedStateInstance){
        ...
        setContentView(R.layout.quiz_html_question3);
    }

    public void continueQuiz(View view){

        radioButton1 = (RadioButton)findViewById(R.id.quiz_html_option3_1);
        radioButton2 = (RadioButton)findViewById(R.id.quiz_html_option3_2);
        ...
        if(extras.containsKey("POINTS")) {
            ...
            if(!radioButton1.isChecked() && !radioButton2.isChecked()){
                ...
                Log.v("points quiz 3: ", "" + pointsHtml);
                intent = new Intent(this, QuizHtmlQuestion4.class);
