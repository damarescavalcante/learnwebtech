 ...
 */
public class QuizHtmlQuestion4 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedStateInstance){
        ...
        setContentView(R.layout.quiz_html_question4);
    }
    ...
    public void continueQuiz(View view){
        ...
        radioButton1 = (RadioButton)findViewById(R.id.quiz_html_option4_1);
        radioButton2 = (RadioButton)findViewById(R.id.quiz_html_option4_2);
        ...
        if(extras.containsKey("POINTS")) {
            ...
            if(!radioButton1.isChecked() && !radioButton2.isChecked()){
                ...
                Log.v("points quiz 4: ", "" + pointsHtml);
                intent = new Intent(this, QuizHtmlQuestion5.class);
