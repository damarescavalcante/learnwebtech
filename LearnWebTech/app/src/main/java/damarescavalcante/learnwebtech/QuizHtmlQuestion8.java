 ...
 */
public class QuizHtmlQuestion8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedStateInstance){
        ...
        setContentView(R.layout.quiz_html_question8);
    }

    public void continueQuiz(View view){

        radioButton1 = (RadioButton)findViewById(R.id.quiz_html_option8_1);
        radioButton2 = (RadioButton)findViewById(R.id.quiz_html_option8_2);
        ...
        if(extras.containsKey("POINTS")) {
            ...
            if(!radioButton1.isChecked() && !radioButton2.isChecked()){
                ...
                intent = new Intent(this, QuizHtmlQuestion9.class);
