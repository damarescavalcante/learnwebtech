 ...
 */
public class QuizHtmlQuestion6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedStateInstance){
        ...
        setContentView(R.layout.quiz_html_question6);
    }

    public void continueQuiz(View view){

        radioButton1 = (RadioButton)findViewById(R.id.quiz_html_option6_1);
        radioButton2 = (RadioButton)findViewById(R.id.quiz_html_option6_2);
        ...
        if(extras.containsKey("POINTS")) {
            ...
            if(!radioButton1.isChecked() && !radioButton2.isChecked()){
                ...
                Log.v("points quiz 6: ", "" + pointsHtml);
                intent = new Intent(this, QuizHtmlQuestion7.class);
